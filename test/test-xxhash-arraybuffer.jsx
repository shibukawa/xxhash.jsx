...
class _Test extends TestCase
{
    ...
    function join(str : string, num : int) : ArrayBuffer {
        var array = [] : string[];
        for (var i = 0; i < num + 1; i++) {
            array.push('');
        }
        return this.toArray(array.join(str));
    }

    function toArray(str : string) : ArrayBuffer {
        var result = new ArrayBuffer(str.length);
        var uintArray = new Uint8Array(result);
